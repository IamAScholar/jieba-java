 ...
 */
public class JiebaTests extends TestCase {
    ...
    @Test
    public void testAccurateHMM() {
        List<Word> result = jieba.cut("这是一个伸手不见五指的黑夜。我叫孙悟空，我爱北京，我爱Python和C++。", false, true);
    ...
    public void testCutAll() {
        List<Word> result = jieba.cut("这是一个伸手不见五指的黑夜。我叫孙悟空，我爱北京，我爱Python和C++。", true, false);
        for (Word word : result) {
            System.out.println(word);
        }
    }
    ...
    public void testExtractTags() {
        List<Analyzer.Word> result = jieba.getAnalyzer().extractTags("这是一个伸手不见五指的黑夜。我叫孙悟空，我爱北京，我爱Python和C++。", 20);
        for (Analyzer.Word word : result) {
            System.out.println(word);
        }
    }
