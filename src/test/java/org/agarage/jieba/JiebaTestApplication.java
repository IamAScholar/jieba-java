 ...
 */
public class JiebaTestApplication {
...
//        Jieba jieba = Jieba.create();
//        List<String> result = jieba.cut("这是一个伸手不见五指的黑夜。我叫孙悟空，我爱北京，我爱Python和C++。", false, true);
//        List<String> result = jieba.cutForSearch("这是一个伸手不见五指的黑夜。我叫孙悟空，我爱北京，我爱Python和C++。", true);
